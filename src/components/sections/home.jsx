...
export const Home = () =>{
    return(
        ...
        <div className="text-center z-10 px-4 font-mono text-grey-400">
             <h1 className="text-5xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-yellow-500 to-purple-600 bg-clip-text text-transparent leading-right">
             ...
             <div className="flex justify-center space-x-4">
                ...
                <a href="#projects" className="border border-yellow-500/50 text-yellow-500 py-3 px-6 rounded font-medium transition-all duration-200
